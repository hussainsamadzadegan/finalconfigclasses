...
use Mysidia\Resource\Native\Boolean as BooleanObject;
use Mysidia\Resource\Native\Integer as IntegerObject;
use Mysidia\Resource\Native\StringWrapper as StringObject;
 ...
 */
class StringWrapper extends Object implements Iterator, Serializable
{
    /**
    ...
    private function initWithChars(Arrays $arrays)
    {
        ...
        $this->initWithString(new StringWrapper($arrays->join()));
    }
     ...
     * @return StringObject
     */
    public function padEnd(IntegerObject $length, StringWrapper $padding = null)
    {
        if ($padding === null) {
            $padding = " ";
        }
     ...
     * @return StringObject
     */
    public function padStart(IntegerObject $length, StringWrapper $padding = null)
    {
        if (!$padding) {
            $padding = " ";
        }
     ...
     * @return StringObject
     */
    public function trimStart(StringWrapper $mask = null)
    {
        if ($mask !== null) {
            $mask = $mask->value();
        }
	...
	public function unserialize($string) {
		list($chars, $hash, $length, $offset, $spaces, $value, $makeFluent, $useObjectParameters) = unserialize($string);
